...
const Product = () => {
  ...
  const handlePicker = (selectPayload) => {
    ...
    const selectedProductIds = selectPayload.selection.map(
      (selection) => selection.id
    );
    console.log(selectedProductIds[0]);

    // let LogProducts = console.log(selectedProductIds[0])
  ...
  return (
    ...
    >
      ...
      <Button onClick={() => console.log("LogProducts")}>Select options</Button>
    </Page>
  );
};
